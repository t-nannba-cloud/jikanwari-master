...
function createDefaultPresets(): TimePreset[] {
  return [
    ...
    },
    {
      ...
      slots: {
        '1': { label: '1時限', start: '17:30', end: '18:00' },
        '2': { label: '2時限', start: '18:30', end: '19:10' },
        '3': { label: '3時限', start: '19:20', end: '20:00' },
        '4': { label: '4時限', start: '20:10', end: '20:50' },
        '5': { label: '5時限', start: '20:50', end: '20:50' },
        '6': { label: '6時限', start: '20:50', end: '20:50' },
        '放課後': { label: '放課後', start: '20:50', end: '20:50' },
      },
    },
    {
      id: 'ceremony',
